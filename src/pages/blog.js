...
import article1 from '../../public/images/articles/hello-world.png'
...
const blog = () => {
  return (
    <>
        <Head>
            <title>Joseph Rasanjana | Blog Page</title>
            <meta name="desctiption" content="Joseph Rasanjana | Blog Page"/>
        </Head>
